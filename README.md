...
## Принципы расчета категориальных переменных, отвечающих за Внешний Мир
---
...
*   **`солнечное_затмение_cat` / `лунное_затмение_cat` **
...
*   **`wth_temp_change_cat`, `wth_precipitation_change_cat`, `wth_pressure_change_cat`, `wth_wind_speed_change_cat` **
...
*   **`wth_bad_weather_last5_cat` / `wth_extreme_temp_last5_cat` **
...
*   **`wth_national_bad_weather_scale_cat` / `wth_national_temp_anomaly_scale_cat` **
